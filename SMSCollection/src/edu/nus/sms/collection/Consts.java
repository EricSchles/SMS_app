...
final class Consts {
    ...
    /**DONATE used for logging. */
    static final String DONATE="SmsDonate";
  ...
  //  static final String URL_INFO_LINK = "http://code.google.com/p/android-sms/wiki/UserGuide"
    static final String URL_INFO_LINK = "http://wing.comp.nus.edu.sg:8080/SMSCorpus/appUserGuide.jsp";;

    /*************need modify*******************/
    /** Market link to details of this application. */
    static final String URL_MARKET_SEARCH =
        "http://market.android.com/search?q=pname:edu.nus.sms.collection";
